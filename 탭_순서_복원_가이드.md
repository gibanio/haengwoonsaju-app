...
- 탭 순서: **오행샵** → 마이
- 기본 페이지: **오행샵** 탭
- **행운 탭 숨김 처리** (href: null) - 인앱결제 제거 작업 완료 (2025-01-26)
- **사주풀이 탭 숨김 처리** (href: null) - PG 결제 기능 숨김 (2025-01-26)
...
**주의**: luck 탭과 fortune 탭의 `href: null` 옵션을 **제거**해야 합니다.
...
- [ ] 행운 탭에서 이미지/PDF 저장 기능이 정상 동작하는지 확인
- [ ] 사주풀이 탭에서 PG 결제 기능이 정상 동작하는지 확인
...
- **2025-01-26**: 앱스토어 통과를 위해 사주풀이 탭 추가 숨김 (PG 결제 제거)
- **이전**: 앱스토어 통과를 위해 탭 순서 변경 및 행운 탭 숨김 (인앱결제 제거)
